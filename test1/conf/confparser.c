...
int32_t confparser_serialize_tnt_config(uint8_t *buffer, const tnt_config *conf) {
	...
	buffer_append_float16(buffer, conf->kp0, 10, &ind);
	...
	buffer_append_float16(buffer, conf->Q1, 100, &ind);
	buffer_append_float16(buffer, conf->Q2, 100, &ind);
	buffer_append_float16(buffer, conf->theta, 100, &ind);
...
bool confparser_deserialize_tnt_config(const uint8_t *buffer, tnt_config *conf) {
	...
	conf->kp0 = buffer_get_float16(buffer, 10, &ind);
	...
	conf->Q1 = buffer_get_float16(buffer, 100, &ind);
	conf->Q2 = buffer_get_float16(buffer, 100, &ind);
	conf->theta = buffer_get_float16(buffer, 100, &ind);
...
void confparser_set_defaults_tnt_config(tnt_config *conf) {
	...
	conf->Q1 = APPCONF_TNT_KALMAN_Q1;
	conf->Q2 = APPCONF_TNT_KALMAN_Q2;
	conf->theta = APPCONF_TNT_KALMAN_THETA;
